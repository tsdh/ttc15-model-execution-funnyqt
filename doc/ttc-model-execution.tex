...
those nodes of a given activity which are set running, are no initial nodes,
and receive an offer on each incoming control flow, or, in the case of a merge
