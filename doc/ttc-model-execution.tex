...
\begin{table}[h!tb]
  ...
  \begin{tabular}{|l | r |}
    ...
    \hline
    \emph{test1} & 1.9 ms 1.3 ms\\
    \emph{test2} & 0.8 ms 0.6 ms\\
    \emph{test3} & 4.7 ms 4.1 ms\\
    \emph{test4} & 6.3 ms 3.2 ms\\
    \emph{test5} & 0.8 ms 0.5 ms\\
    \emph{test6 (false)} & 8.1 ms 3.7 ms\\
    \emph{test6 (true)}  & 10.8 ms 5.4 ms\\
    \emph{test-performance-variant-1} & 2167.3 ms 1104.0 ms\\
    \emph{test-performance-variant-2} & 228.5 ms 1246.5 ms\\
    \emph{test-performance-variant-3-1} & 129.2 ms 1159.6 ms\\
    \emph{test-performance-variant-3-2} & 204.8 ms 72.7 ms\\
    \hline
  \end{tabular}
